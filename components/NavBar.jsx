...
const NavBar = () => {
  return (
    ...
    <header className="text-gray-600 body-font  bg-cyan-600">
      <div className="container mx-auto flex flex-wrap p-5 font-bold flex-col md:flex-row text-white items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap font-bold  text-white items-center text-base justify-center">
